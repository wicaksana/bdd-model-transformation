 ...
 * </p>
 * <ul>
 *   <li>{@link com.mde.sample.impl.WhenImpl#getSentences <em>Sentences</em>}</li>
 * </ul>
 *
 * @generated
 */
public class WhenImpl extends MinimalEObjectImpl.Container implements When {
	...
	protected EClass eStaticClass() {
		return SamplePackage.Literals.WHEN;
	}
	...
	public EList<Sentence> getSentences() {
		if (sentences == null) {
			sentences = new EObjectContainmentEList<Sentence>(Sentence.class, this, SamplePackage.WHEN__SENTENCES);
		}
		return sentences;
	}
