 ...
 * </p>
 * <ul>
 *   <li>{@link com.mde.sample.impl.RegisterImpl#getStories <em>Stories</em>}</li>
 *   <li>{@link com.mde.sample.impl.RegisterImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RegisterImpl extends MinimalEObjectImpl.Container implements Register {
	...
	protected EClass eStaticClass() {
		return SamplePackage.Literals.REGISTER;
	}
	...
	public EList<Story> getStories() {
		if (stories == null) {
			stories = new EObjectContainmentEList<Story>(Story.class, this, SamplePackage.REGISTER__STORIES);
		}
		return stories;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SamplePackage.REGISTER__NAME, oldName, name));
	}
