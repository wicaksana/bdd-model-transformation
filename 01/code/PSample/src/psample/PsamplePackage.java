...
public interface PsamplePackage extends EPackage {
	 ...
	 * @ordered
	 */
	int PRIMITIVE_TYPE_VARIABLE_FEATURE_COUNT = TYPE_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int FUNCTION_FEATURE_COUNT = MEMBER_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int VARIABLE_FEATURE_COUNT = MEMBER_FEATURE_COUNT + 0;
