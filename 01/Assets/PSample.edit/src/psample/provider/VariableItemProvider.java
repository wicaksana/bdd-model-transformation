...
/**
 * This is the item provider adapter for a {@link psample.Variable} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VariableItemProvider extends MemberItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Variable_isParameter_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Variable_isParameter_feature", "_UI_Variable_type"),
				 PsamplePackage.Literals.VARIABLE__IS_PARAMETER,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Variable.class)) {
			case PsamplePackage.VARIABLE__IS_PARAMETER:
